...
def multi_case_algorithm_ML1_devRF(storm_relative_dir, zdrlev, kdplev, REFlev, REFlev1, big_storm, zero_z_trigger, storm_to_track, year, month, day, hour, start_min, duration, calibration, station, h_Z0C, Bunkers_m, track_dis=10, GR_mins=5.0):
    ...
    #Local file option:
        ...
        if len(max_lons_c) > 0:
            ...
            [rot_mag1, rot_lat1, rot_lon1, rot_storm_lon_1, rot_storm_lat_1] = rot_storm_matcher_qc(shear_maxes1,shear_lats1, shear_lons1,ax,f,time_start,month,d_beg,h_beg,min_beg,sec_beg,d_end,h_end,min_end,sec_end,rlons,rlats,max_lons_c,max_lats_c,proj,tracking_ind, rlons_2d, rlats_2d, REFall, KDPall, CCall, grad_ffd, grad_mag, ZDR_sum_stuff, az_masked, storm_relative_dir, station, dt, forest_loaded_mesos, 4)
            
            #Getting 1.5km rotation objects
            [rot_mag15, rot_lat15, rot_lon15, rot_storm_lon_15, rot_storm_lat_15] = rot_storm_matcher_qc(shear_maxes15,shear_lats15, shear_lons15,ax,f,time_start,month,d_beg,h_beg,min_beg,sec_beg,d_end,h_end,min_end,sec_end,rlons,rlats,max_lons_c,max_lats_c,proj,tracking_ind, rlons_2d, rlats_2d, REFall, KDPall, CCall, grad_ffd, grad_mag, ZDR_sum_stuff, az_masked, storm_relative_dir, station, dt, forest_loaded_mesos, 12)
            
            #Getting 2km rotation objects
            [rot_mag2, rot_lat2, rot_lon2, rot_storm_lon_2, rot_storm_lat_2] = rot_storm_matcher_qc(shear_maxes2,shear_lats2, shear_lons2,ax,f,time_start,month,d_beg,h_beg,min_beg,sec_beg,d_end,h_end,min_end,sec_end,rlons,rlats,max_lons_c,max_lats_c,proj,tracking_ind, rlons_2d, rlats_2d, REFall, KDPall, CCall, grad_ffd, grad_mag, ZDR_sum_stuff, az_masked, storm_relative_dir, station, dt, forest_loaded_mesos, 20)
            
            #Getting 2.5km rotation objects
            [rot_mag25, rot_lat25, rot_lon25, rot_storm_lon_25, rot_storm_lat_25] = rot_storm_matcher_qc(shear_maxes25,shear_lats25, shear_lons25,ax,f,time_start,month,d_beg,h_beg,min_beg,sec_beg,d_end,h_end,min_end,sec_end,rlons,rlats,max_lons_c,max_lats_c,proj,tracking_ind, rlons_2d, rlats_2d, REFall, KDPall, CCall, grad_ffd, grad_mag, ZDR_sum_stuff, az_masked, storm_relative_dir, station, dt, forest_loaded_mesos, 28)

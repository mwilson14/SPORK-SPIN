...
def multi_case_algorithm_ML1_devLOCAL(storm_relative_dir, zdrlev, kdplev, REFlev, REFlev1, big_storm, zero_z_trigger, storm_to_track, year, month, day, hour, start_min, duration, calibration, station, h_Z0C, localfolder, track_dis=10):
...
#             zdr_con_areas1 = zdr_con_areas_arr[zdr_con_areas_arr > area]
        ...
        alt_levs = [1000, 2000]
        plt.savefig('Machine_Learning/NEW_SPORK_2'+station+str(time_start.year)+str(time_start.month)+str(day)+str(hour)+str(minute)+'.png')
        print('Figure Saved')
        plt.close()
